        ...
        <script>
            ...
            var user_type = new SlimSelect({
                ...
                ajax: function (search, callback) {
                    fetch('policy/search-user-types', {
                        method: 'POST',
            ...
            $(document).on('click', '.editrec', function () {
                ...
                fetch('policy/user/' + id).then(resp => resp.json())
                        .then((data) => {
                            clearForm();
                            $('#name').val(data.name);
            ...
            $('#saveBtn').click(function () {
                ...
                Swal.fire({
                    ...
                    searchHighlight: true,
                    preConfirm: () => {
                        return fetch('policy/' + $('#saveBtn').data('mode') + '-user', {
                            method: 'POST',
                            body: formData
                        }).then(response => {
                            if (!response.ok) {
            ...
            $(document).on('click', '.delrec', function () {
                ...
                Swal.fire({
                    ...
                    showLoaderOnConfirm: true,
                    preConfirm: () => {
                        return fetch('policy/deactivate-user', {
                            method: 'POST',
            ...
            $(document).on('click', '.rerec', function () {
                ...
                Swal.fire({
                    ...
                    showLoaderOnConfirm: true,
                    preConfirm: () => {
                        return fetch('policy/reactivate-user', {
                            method: 'POST',
                            body: new URLSearchParams({
                                id: id
                            })
