...
public class DataTableRepo<T> {
    ...
    public DataTablesResponse<IdeaReviewDataTable> getReviews(Class<IdeaReviewDataTable> aClass, DataTableRequest param, String select_idlast_actioncommentresponsibility) {
