...
//                        formData.append('data', JSON.stringify(data));
                    ...
                    Swal.fire({
                        ...
                        preConfirm: () => {
                            return fetch('policy/user-type-save', {
                                method: 'POST',
...
//                        formData.append('data', JSON.stringify(data));
                    ...
                    Swal.fire({
                        ...
                        allowOutsideClick: () => !Swal.isLoading(),
                        preConfirm: () => {
                            return fetch('policy/user-type-update', {
                                method: 'POST',
                                body: new URLSearchParams({
                                    id: $('#saveBtn').data('id'),
                                    name: document.getElementById('name').value,
            ...
            $(document).on('click', '.editrec', function () {
                ...
                $.post('policy/get-userType', {id: id}, function (result) {
...
//                        }
            ...
            $(document).on('click', '.delrec', function ()
            {
                ...
                Swal.fire({
                    ...
                    showLoaderOnConfirm: true,
                    preConfirm: () => {
                        return fetch('policy/deactivate-user-Type', {
                            method: 'POST',
                            body: new URLSearchParams({
                                id: id
                            })
            ...
            $(document).on('click', '.rerec', function ()
            {
                ...
                Swal.fire({
                    ...
                    showLoaderOnConfirm: true,
                    preConfirm: () => {
                        return fetch('policy/reactivate-user-Type', {
                            method: 'POST',
                            body: new URLSearchParams({
                                id: id
                            })
