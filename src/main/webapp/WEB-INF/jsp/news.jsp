                        ...
                        <div class="card" >
                            ...
                            <div class="card-footer">
                                <div class="text-right">
                                    <button id="addNewsBtn" class="btn btn-sm waves-effect waves-light btn-danger"><i class="icon feather icon-plus"></i>Add News</button>
                                </div>
                            </div>
                        </div>
...
//            });
            ...
            $(document).on('click', '.delrec', function () {
                ...
                Swal.fire({
                    ...
                    preConfirm: () => {
                        return fetch('news/deactivate-news', {
                            method: 'POST',
            ...
            $(document).on('click', '.rerec', function () {
                ...
                Swal.fire({
                    ...
                    showLoaderOnConfirm: true,
                    preConfirm: () => {
                        return fetch('news/reactivate-news', {
                            method: 'POST',
                            body: new URLSearchParams({
                                id: id
                            })
            ...
            document.getElementById('saveBtn').addEventListener('click', function () {
                ...
                if (mode === 'save') {
                    ...
                    let para = $('#para').val();
                    let fileInput = document.getElementById('other_images');
                    ...
                    $.ajax({
                        url: 'news/update', // Replace with the actual update endpoint
                        type: 'POST',
                        data: formData,
                        processData: false,
                        contentType: false,
