...
<html>
    ...
    <body>
        ...
        <div class="row"style="padding-top: 2rem;padding-left: 5rem;padding-right: 0.1rem;height: 3rem;">
            <div class="col">
                <a href="#" style="text-decoration: none; color: black;" data-toggle="modal" data-target="#ceoModel">
                    <div class="cards" style="width: 100%; background-color: #f0f1f5;">
                        <div class="row">
                            <div class="col-2">
            ...
            <div class="col">
                <a href="view_policies" style="text-decoration: none; color: black;">
                    <div class="cards" style="width: 80%;background-color: #f0f1f5;">
                        <div class="row">
                            <div class="col-2">
                            ...
                            <div class="col-10">
                                <div class="txt" style="margin-top: 5px; font-family: 'Exo 2', sans-serif; font-weight: 1000">
                                    <p style="font-size: 0.9rem;">Policy</p>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col">
                <a href="#" id="view_dele" style="text-decoration: none; color: black;">
                    <div class="cards" style="margin-left: -2.8rem;background-color: #f0f1f5;">
                        <div class="row">
                            <div class="col-3">
                                <img src="assets/img/system/carousel/delegation.png" width="40px" height="40px" alt="alt" />
                            </div>
                            <div class="col-9">
                                <div class="txt" style="margin-top: 5px;margin-left: -1rem; font-family: 'Exo 2', sans-serif; font-weight: 1000">
            ...
            <div class="col">
                <a href="#" id="view_alco" style="text-decoration: none; color: black;">
                    <div class="cards" style="width: 85%;background-color: #f0f1f5;margin-left: -0.8rem">
                        <div class="row">
                            <div class="col-3">
            ...
            <div class="col">
                <a href="#"id="ideas-link" style="text-decoration: none; color: black;">
                    <div class="cards" style="width: 85%;background-color: #f0f1f5;margin-left: -3rem">
                        <div class="row">
                            <div class="col-2">
                            ...
                            <div class="col-10">
                                <div class="txt" style="margin-top: 5px; font-family: 'Exo 2', sans-serif; font-weight: 1000">
                                    <p style="font-size: 0.9rem;">Ideas</p>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col">
                <a href="#" id="whistleblowing-link" style="text-decoration: none; color: black;">
                    ...
                    <div class="cards"style="width: 125%;margin-left: -5.4rem;background-color: #f0f1f5;">
                        <div class="row">
                            <div class="col-2">
                                <img src="assets/img/system/carousel/whis.png" width="40px" height="40px" alt="alt" />
                            </div>
                            <div class="col-10">
                                <div class="txt" style="margin-top: 5px;margin-left: 15px; font-family: 'Exo 2', sans-serif; font-weight: 1000">
            ...
            <div class="col">
                <a href="#" id="select-link" style="text-decoration: none; color: black;">
                    ...
                    <div class="cards"style="width: 90%;margin-left: -3.4rem;background-color: #f0f1f5;">
                        <div class="row">
                            <div class="col-2">
                                <img src="assets/img/system/carousel/whis.png" width="40px" height="40px" alt="alt" />
                            </div>
        ...
        <div class="contact-inner area-padding">
            ...
            <div class="container" style="font-family: myFontB">
                ...
                <div class="row"style="margin-top: 1rem">
                    ...
                    <!-- End Google Map -->
                    <div class="col-md-6 col-sm-6 col-xs-6" style="padding-left: 35px">
