        ...
        <div class="tab-pane fade show active profile-overview" id="profile-overview">
            ...
            <div class="page-wrapper">
                <div class="page-body">
                    ...
                    <div class="row" id="viewform" style="margin-top: 2rem;">
                        ...
                        <div class="card" >
                            <div class="card-header">
                                <h4>About Us & Cover Image</h4>

                            </div>
                            <div class="card-block p-b-0">
                                <div class="table-responsive">
                                    <table class="table table-hover table-bordered m-b-0" id="tbl2">
                                        <thead>
                                            <tr>
                                                <th>Id</th>
                                                <th>About Us</th>                                             
                            ...
                            <div class="card-footer">
                                <div class="text-right">
                                    <button id="addSytemsBtn" class="btn btn-sm waves-effect waves-light btn-danger"><i class="icon feather icon-plus"></i>Add About Us</button>
                                </div>
                            </div>
                        </div>
                ...
                <script>
                    ...
                    $(document).on('click', '.delrec', function () {
                        ...
                        Swal.fire({
                            title: 'Are you sure?',
                            text: "This About Us Will be Deleted!",
                            icon: 'warning',
                            ...
                            preConfirm: () => {
                                return fetch('department/deactivate-aboutus', {
                                    method: 'POST',
                            ...
                            if (result.value) {
                                if (result.value.status !== 200) {
                                    ...
                                    Swal.fire('Successfull!', 'About Us has been Deactivated !', 'success');
                                    dtable1.ajax.reload();
                                    $('#addform').hide();
                                    $('#viewform').fadeIn();
                    ...
                    $(document).on('click', '.rerec', function () {
                        ...
                        Swal.fire({
                            title: 'Are you sure?',
                            text: "About Us Will be Activated!",
                            icon: 'warning',
                            showCancelButton: true,
                            confirmButtonColor: '#3085d6',
                            cancelButtonColor: '#d33',
                            ...
                            showLoaderOnConfirm: true,
                            preConfirm: () => {
                                return fetch('department/reactivate-aboutus', {
                                    method: 'POST',
                                    body: new URLSearchParams({
                                        id: id
                                    })
                            ...
                            if (result.value) {
                                if (result.value.status !== 200) {
                                    ...
                                    Swal.fire('Successfull!', 'About Us has been Activated !', 'success');
                                    dtable1.ajax.reload();
                                    $('#addform').hide();
                                    $('#viewform').fadeIn();
                    ...
                    $('#addSytemsBtn').click(function () {
                        $('#saveUsbtn').data('mode', 'save');
                        $('#saveUsbtn').html('<i class="icon feather icon-save"></i>Save');
                        clearForm();
                        $('#viewform').hide();
                        $('#tableSection').hide();
                        $('#addform').fadeIn();
                    ...
                    $(document).on('click', '.editrec', function () {
                        ...
                        fetch('department/detailss/' + id)
                                ...
                                .then((resp) => {
                                    ...
                                    $('#saveUsbtn').data('mode', 'update'); // Set the mode to 'update'
                                    $('#saveUsbtn').data('id', id);
                                    $('#saveUsbtn').html('<i class="icon feather icon-save"></i>Update'); // Change button text to 'Update'
                                    $('#addform').fadeIn();
                                    $('#viewform').hide();
                                    finishLoadDiv($('#viewform'));
                                });
                    });


                    document.getElementById('saveUsbtn').addEventListener('click', function () {

                        if ($('#about_us').val().trim() === '') {
                            Swal.fire("Empty Paragraph!", "Please Enter a Valid Paragraph!", "warning");
                            return;
                        }
                        let mode = $('#saveUsbtn').data('mode'); // Get the mode (save or update) from the button's data
                        ...
                        if (mode === 'save') {
                            ...
                            fetch('department/saves', {
                                ...
                                if (!response.ok) {
                                    ...
                                    Swal.fire('Successful!', 'About Us has been successfully saved', 'success');
                                    clearForm();
                                    $('#addform').hide();
                                    $('#viewform').fadeIn();
                            ...
                            $.ajax({
                                url: 'department/updates', // Replace with the actual update endpoint
                                type: 'POST',
                                data: formData,
                                processData: false,
                                contentType: false,
                                success: function (response) {
                                    if (response.status === 200) {
                                        Swal.fire('Successful!', 'About Us details updated successfully', 'success');
                                        clearForm();
                                        $('#addform').hide();
                                        $('#viewform').fadeIn();
                                ...
                                error: function (xhr, status, error) {
                                    ...
                                    console.log(status);
                                    console.log(error);
                                    Swal.fire('Error!', 'Failed to update About Us details', 'error');
                                }
                            });
                        }
                    });
                    ...
                    var debounce = new $.fn.dataTable.Debounce(dtable1);
