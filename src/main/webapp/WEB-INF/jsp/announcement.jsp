                        ...
                        <div class="card" >
                            ...
                            <div class="card-footer">
                                <div class="text-right">
                                    <button id="addAnnouncBtn" class="btn btn-sm waves-effect waves-light btn-danger"><i class="icon feather icon-plus"></i>Add Announcement</button>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card-block p-b-0">
                                ...
                                <div class="col-lg-6 col-12">
                                    <div class="form-group">
                                        <label for="paragraph">Date<span class="text-danger">*</span></label>
    ...
    <script>
        ...
        $(document).on('click', '.delrec', function () {
            ...
            Swal.fire({
                ...
                preConfirm: () => {
                    return fetch('announcement/deactivate-announcement', {
                        method: 'POST',
                ...
                if (result.value) {
                    if (result.value.status !== 200) {
                        ...
                        Swal.fire('Successfull!', 'Announcement has been Deactivated !', 'success');
                        dtable.ajax.reload();
                        $('#formSection').hide();
                        $('#tableSection').fadeIn();
                    }
        ...
        $(document).on('click', '.rerec', function () {
            ...
            Swal.fire({
                title: 'Are you sure?',
                text: "Announcement Will be Activated!",
                icon: 'warning',
                showCancelButton: true,
                confirmButtonColor: '#3085d6',
                cancelButtonColor: '#d33',
                ...
                showLoaderOnConfirm: true,
                preConfirm: () => {
                    return fetch('announcement/reactivate-announcement', {
                        method: 'POST',
                        body: new URLSearchParams({
                            id: id
                        })
                ...
                if (result.value) {
                    if (result.value.status !== 200) {
                        ...
                        Swal.fire('Successfull!', 'Announcement has been Activated !', 'success');
                        dtable.ajax.reload();
                        $('#formSection').hide();
                        $('#tableSection').fadeIn();
                    }
            ...
            if (mode === 'save') {
                ...
                fetch('announcement/save', {
                    ...
                    if (!response.ok) {
                        ...
                        Swal.fire('Successful!', 'Announcement has been successfully saved', 'success');
                        clearForm();
                        $('#formSection').hide();
                        $('#tableSection').fadeIn();
                        dtable.ajax.reload();
                ...
                $.ajax({
                    url: 'announcement/update', // Replace with the actual update endpoint
                    type: 'POST',
                    data: formData,
                    processData: false,
                    contentType: false,
                    ...
                    error: function (xhr, status, error) {
                        ...
                        console.log(status);
                        console.log(error);
                        Swal.fire('Error!', 'Failed to update Announcement details', 'error');
                    }
                });
            }
        });
